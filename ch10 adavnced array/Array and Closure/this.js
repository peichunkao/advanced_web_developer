...
function sumEvenArguments(){
    ...
    return argumentArray.reduce((acc, nextValue) => {
      	if(nextValue % 2 === 0) {
...
function bind(fn, thisArg){
	var firstHalfArguments = [].slice.call(arguments, 2)
    return function() {
		var secondHalfArguments = [].slice.call(arguments, 0)
		var allArguments = [...firstHalfArguments, ...secondHalfArguments];
...
function flip(fn, thisArg){
	var firstHalfArguments = [].slice.call(arguments, 2);
	return function() {
		var secondHalfArguments = [].slice.call(arguments);
		var allArguments = [...firstHalfArguments, ...secondHalfArguments].splice(0,fn.length).reverse();
		return fn.apply(thisArg, allArguments)
	}
}
