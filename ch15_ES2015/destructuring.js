...
function createStudent({likesES2015 = true, likesJavaScript= true} = {}){
    let result = 'The student likes ';
    // console.log(likesES2015 + '  ' + likesJavaScript)
    if(likesES2015 && likesJavaScript) {
        return result + 'JavaScript and ES2015'
    } else if (!likesES2015 && likesJavaScript) {
        return result + 'JavaScript'
    } else if (likesES2015 && !likesJavaScript) {
        return result + 'ES2015'
    } else {
        return result + 'does not like much...'
    }
}
...
function reverseArraySpreading(arr){
...
console.log(reverseArraySpreading([1,2,3,4,5]))